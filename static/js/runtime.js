...
const ue = new Map, ce = [], de = ce.map, fe = ce.some, pe = ce.hasOwnProperty, he = "https://cdn.jsdelivr.net/npm/",
    me = /^((?:@[^/@]+\/)?[^/@]+)(?:@([^/]+))?(?:\/(.*))?$/, ve = /^\d+\.\d+\.\d+(-[\w-.+]+)?$/, be = /\.[^/]*$/,
...
var ge = Ee((async function (e, t) {
    ...
    const r = await ye(n);
    return `${he}${r.name}@${r.version}/${n.path || function (e) {
        for (const t of _e) {
            const n = e[t];
...
var Oe = {
    canvas: function (e, t) {
        ...
        if (t) for (var a in t) i = (r = a).indexOf(":"), n = t[a], i >= 0 && "xmlns" !== (r = a.slice(0, i)) && (a = a.slice(i + 1)), Le.hasOwnProperty(r) ? o.setAttributeNS(Le[r], a, n) : o.setAttribute(a, n);
        return o
    }, input: function (e) {
...
var Fe = {
    disposable: Ue, filter: function* (e, t) {
...
var ot = Array.prototype, at = ot.map, st = ot.forEach;
...
function _t(e, t = []) {
    Object.defineProperties(this, {
        ...
        _builtins: {value: new Map([["invalidation", gt], ["visibility", Et], ...t])},
    ...
    _copy: {
        value: function (e, t) {
            ...
            for (const [o, a] of this._scope) {
                ...
                if (!n || 1 !== n._type) if (a._definition === ut) {
        ...
        value: function (e, t) {
            ...
            return n._source = this, st.call(e, (function (e) {
                ...
                for (const t of e) for (const n of t._scope.values()) if (n._definition === ut) {
...
function xt(e = new rt, t = kt) {
    ...
    if (Object.defineProperties(this, {
        ...
        _builtin: {value: n},
        _global: {value: t}
    }), e) for (var r in e) new ft(2, n).define(r, [], e[r])
}
...
function jt(e) {
    ...
    var t = e._value, n = ++e._version, r = null, i = e._promise = Promise.all(e._inputs.map(Pt)).then((function (i) {
        if (e._version === n) {
...
Object.defineProperties(xt, {
    load: {
        value: function (e, t, n) {
            ...
            null == t && (t = new rt);
            const {modules: r, id: i} = e, o = new Map, a = new xt(t), s = l(i);
